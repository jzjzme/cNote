...
var LoanOffer = /** @class */ (function (_super) {
    ...
    LoanOffer.prototype.getLoanOfferHash = function () {
        return web3_utils_1.Web3Utils.soliditySHA3(this.data.creditor, this.data.issuanceVersion, this.data.creditorFee, this.data.underwriter, this.data.underwriterRiskRating, this.data.termsContract, this.data.termsContractParameters, this.data.expirationTimestampInSec, this.data.salt);
    };
    return LoanOffer;
